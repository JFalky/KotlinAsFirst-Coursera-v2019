 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = ((48 * sagenes + vershoks + 16 * arshins) * 4.445) / 100
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * ((100 + percent) / 100.0).pow(3.0)
...
/**
 * Выводим ответ для функции numberRevert для числа 167
 */
 fun main(args: Array<String>) {
    val result = numberRevert(167)
